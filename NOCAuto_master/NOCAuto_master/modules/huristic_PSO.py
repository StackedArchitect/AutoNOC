...
def  source_destination_generator_pos(m,n ,iter_size =4100,pop_size = 600):
    ...
    ##################################################################
    #iter_size =4100  ----> Both iter_size and pop size are declared in the function declaration.
    #pop_size = 600
    val = m*n
    size = (val*val)-val
